...
export const createAdmin = async (req, res) => {
    try {
        ...
        errorHandler(res, "Error creating admin", 500);
    }
};
...
export const loginAdmin = async (req, res) => {
    ...
    try {
        ...
        success(res, { token: result.token, admin: result.admin }, "Login successful", 200);
    } catch (error) {
        errorHandler(res, "Error logging in admin", 500);
    }
};
